...
/**
 * EspressoLoader - Animierte Kaffeemaschine für Loading States
 *
 * Ersetzt den Hamster-Spinner mit einer charmanten Espresso-Maschine Animation.
 * Perfekt für KI-Generierung mit professionellem, aber freundlichem Look.
 */
export function EspressoLoader() {
  return (
